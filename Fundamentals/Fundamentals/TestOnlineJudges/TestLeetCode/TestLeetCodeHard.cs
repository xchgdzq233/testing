...
namespace Fundamentals.TestOnlineJudges.TestLeetCode
{
    ...
    public class TestLeetCodeHard
    {
        ...
        #region "227 Basic Calculator 2"
        private int _227BasicCalculator2(string s)
        {
            nums = new Stack<int>();
            ops = new Stack<char>();
            int num = 0;
        ...
        private void AddNum(int num, char op)
        {
            nums.Push(num);
            if (ops.Count != 0)
            {
        ...
        {
            #region "227 Basic Calculator 2"
            Assert.That(this._227BasicCalculator2(" 0 "), Is.EqualTo(0));
            Assert.That(this._227BasicCalculator2("10*11*12*13*14"), Is.EqualTo(240240));
            Assert.That(this._227BasicCalculator2("10*11+12+13+14"), Is.EqualTo(149));
            Assert.That(this._227BasicCalculator2(" 13-15 / 12 *2 -51+11 "), Is.EqualTo(-29));
            Assert.That(this._227BasicCalculator2(" 13+15 / 12 "), Is.EqualTo(14));
            Assert.That(this._227BasicCalculator2("13+12*12"), Is.EqualTo(157));
            Assert.That(this._227BasicCalculator2(" 13/12 "), Is.EqualTo(1));
            #endregion
